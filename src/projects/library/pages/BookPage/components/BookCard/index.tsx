...
const regexImg = /\/\/images.weserv.nl\/*/g

const BookCard:FC<IProps> = (props) => {
  ...
  return (
    <div className="book-card-container" onClick={handleClick}>
      <div className="book-card-cover">
        <img
          ...
          onError={({currentTarget}) => {
            if ( currentTarget.src.match(regexImg) ) {
      ...
      <div className="book-card-body">
        <div className="book-body-title">
          {title}
        </div>
        {authors.length > 0 && (
          <div className="book-body-authors">
